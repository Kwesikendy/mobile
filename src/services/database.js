...
export const saveMember = async (memberData) => {
    ...
    try {
        ...
        id, firstName, lastName, dob, age, gender, otherNames, phone, address, localAssembly,
        baptized, waterBaptized, baptizedBy, holyGhostBaptized, presidingElder,
        working, occupation, portfolio, maritalStatus, childrenCount, ministry, otherResponsibilities,
